...
export default class SnakeModel {
  constructor(position) {
    this.segments  = [new Position(position.x + 5, position.y),
      new Position(position.x + 4, position.y),
      new Position(position.x + 3, position.y),
      new Position(position.x + 2, position.y),
      new Position(position.x + 1, position.y), position];
